...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="icons">
        ...
        <xsl:if test="$revision/@searched = 'true'">
            <img alt="searched" src="http://ant.apache.org/ivy/images/searched.gif"
                 title="required a search in repository"/>
        </xsl:if>
        <xsl:if test="$revision/@downloaded = 'true'">
            <img alt="downloaded" src="http://ant.apache.org/ivy/images/downloaded.gif"
    ...
    <xsl:template match="/ivy-report">
        ...
        <html>
            <head>
                ...
                <link href="ivy-report.css" rel="stylesheet" type="text/css"/>
            </head>
            <body>
                <div id="logo">
                    ...
                    <table class="header">
                        ...
                        <tr>
                            ...
                            <td class="value">
                                ...
                                alt="searched" src="http://ant.apache.org/ivy/images/searched.gif"
                                ...
                                alt="downloaded" src="http://ant.apache.org/ivy/images/downloaded.gif"
                                ...
                                alt="evicted" src="http://ant.apache.org/ivy/images/evicted.gif"
                                title="module revisions which were evicted by others"/>,
                                <xsl:value-of select="count($errors)"/> errors<img
                                alt="error" src="http://ant.apache.org/ivy/images/error.gif"
                            ...
                            <table class="header">
                                ...
                                <tr>
                                    ...
                                    <td class="value">
                                        ...
                                        kB downloaded,
                                        <xsl:value-of
                                            select="round(sum(artifacts/artifact[@status='no']/@size) div 1024)"/> kB in
                                        cache)
                                    </td>
                                </tr>
