 ...
 */
class DeviceInfo(val MAC_ADDRESS: Array[Byte] = DeviceInfo.getLocalMacAddress, var name: String, var ip: String, var _deviceType: Byte, var lastConnectionTime: Long = 0L, val shouldSave: Boolean) extends Message {
  def deviceType: Byte = _deviceType
