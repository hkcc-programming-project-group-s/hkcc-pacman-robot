...
public class GameJoystick {
    ...
    public GameJoystick(Resources res) {
        _joystick = (Bitmap) BitmapFactory.decodeResource(res, com.example.student.joystickconsole.R.drawable.joystick);
        _joystickBg = (Bitmap) BitmapFactory.decodeResource(res, com.example.student.joystickconsole.R.drawable.joystick_bg);
    }
